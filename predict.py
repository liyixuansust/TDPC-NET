            ...
            if save_format == 'nii':
                ...
                if snapshot:
                    ...
                    for frame in range(T):
                        ...
                        imageio.imwrite(os.path.join(savepath,'snapshot',name,str(frame)+'.png'), Snapshot_img[:,:,:,frame])
        ...
        if scoring:
            ...
            if snapshot:
                ...
                for frame in range(T):
                    ...
                    imageio.imwrite(os.path.join('snapshot',cfg, name, str(frame) + '.png'), Snapshot_img[:,:,:,frame])
